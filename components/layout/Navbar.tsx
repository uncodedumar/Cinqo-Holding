  ...
  */
  ...
  return (
    ...
    ${visible ? "translate-y-0" : "-translate-y-full"}`}
        ...
        <div className="w-full max-w-[1440px] mx-auto flex items-center justify-between px-6 md:px-12 relative">
          ...
          <div className="flex z-10">
            ...
            >
              ...
              >
                <path
                  d="M24.096 24.2551L45.0002 24.2551L24.096 45.3189L24.096 24.2551Z"
                  fill="#231F20"
                />
                <path
                  d="M24.096 21.1562L45.0002 21.1562L24.096 0.09238L24.096 21.1562Z"
                  fill="#808285"
                />
                <path
                  d="M20.904 24.3351L-0.000227384 24.3352L20.904 45.399L20.904 24.3351Z"
                  fill="#808285"
                />
                <path
                  d="M20.904 21.0761L-0.000227384 21.0761L20.904 0.0123018L20.904 21.0761Z"
                  fill="#231F20"
                />
                <path
                  d="M32 22.0006C32 27.5234 27.7467 32.0006 22.5 32.0006C17.2533 32.0006 13 27.5234 13 22.0006C13 16.4777 17.2533 12.0006 22.5 12.0006C27.7467 12.0006 32 16.4777 32 22.0006Z"
                  fill="#FB333E"
                />
                <path
                  d="M31.5231 22.5006C31.5231 17.4965 27.4833 13.44 22.5 13.44C17.5167 13.44 13.4769 17.4965 13.4769 22.5006C13.4769 27.5046 17.5167 31.5612 22.5 31.5612C27.4833 31.5612 31.5231 27.5046 31.5231 22.5006ZM34 22.5006C34 28.807 28.8964 34.0006 22.5 34.0006C16.1036 34.0006 11 28.807 11 22.5006C11 16.1942 16.1036 11.0006 22.5 11.0006C28.8964 11.0006 34 16.1942 34 22.5006Z"
                  fill="white"
                />
              </svg>
            </Link>
          ...
          <div className="flex items-center z-10 gap-4">
            ...
            >
              <span
                ref={topBarRef}
                className="block h-[2px] w-full rounded-full bg-cream-50 origin-center"
              />
              <span
                ref={midBarRef}
                className="block h-[2px] w-full rounded-full bg-cream-50 origin-center"
      ...
      >
        <div
          className="absolute inset-0 bg-navy-950/95 backdrop-blur-md"
