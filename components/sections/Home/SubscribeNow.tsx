...
export default function SubscribeNow() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white bg-[url('/images/subscribe/SubscribeBg.png')] bg-center bg-cover bg-no-repeat overflow-hidden text-white text-center rounded-[5px] px-4 py-24 flex flex-col items-center gap-6">
